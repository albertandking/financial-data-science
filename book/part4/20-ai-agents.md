...
- **验证**：独立的批判者能发现单智能体的盲点；
- **并行化**：多个智能体可同时处理不同数据源，加速大规模任务；
- **故障隔离**：某个智能体出错不影响整体流水线。
...
评估单次问答 LLM 相对简单：给定问题，比较答案与参考答案。智能体评估则困难得多：

- **路径依赖**：正确结果可经不同轨迹达到，哪种轨迹“更好”？
- **中间步骤**：工具选择对吗？参数合理吗？步数是否过多？
- **错误传播**：某步工具调用返回错误信息，后续步骤如何响应？
- **成本-质量权衡**：一个多调了3次工具才得出正确答案的智能体，比一次调对但偶尔出错的智能体更好吗？
...
智能体的“权限蔓延”是最常见的工程风险之一。如果工具集设计不当，智能体可能：
