...
### 15.6.2 幸存者偏差（Survivorship Bias）
...
### 15.6.3 过拟合（Overfitting）与数据窥探（Data Snooping）
...
- 参数敏感性：策略表现应对参数选择不敏感（见 15.7 节）。

### 15.6.4 未来函数（Future Function）
