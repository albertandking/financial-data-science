...
<figure markdown>
  ![图 17-1　LIQUOR 动量策略回测净值 vs 买入持有](../assets/figures/ch17_backtest.png){ width="680" }
  <figcaption>图 17-1　LIQUOR 动量策略回测净值 vs 买入持有</figcaption>
</figure>
