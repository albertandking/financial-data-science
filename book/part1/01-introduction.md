...
!!! example "例1.2：A股「核心资产」抱团行情中的非平稳性（2017—2021）"
...
!!! example “例1.3：8σ 事件在正态分布下的概率——厚尾低估极端风险的量化测算”
...
!!! example “例1.4：前视偏差如何将50% 准确率伪装成80%——一个逐步演示”
...
!!! example "例1.5：截面动量因子的回测——三种偏差的量化演示"
